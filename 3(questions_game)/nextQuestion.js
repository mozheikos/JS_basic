...
/*Объект "следующий вопрос". Конструктор получает от объекта "вопросы" случайный
вопрос, при помощи метода ask формирует строковое представление без правильного 
